            ...
            <div className="w-full flex flex-col justify-center items-center p-6 mt-4 overflow-hidden">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-3 lg:grid-cols-4 md:w-[90%] mx-auto">
                        <motion.div initial={{opacity: 0, x: -100}} whileInView={{opacity: 1, x:0,}} transition={{durarion: 2.5}} className='displayCard relative h-[300px] md:col-span-2 w-full text-white bg-black rounded-md cursor-pointer'>
                        ...
                        <motion.div initial={{opacity: 0, y: -100}} whileInView={{opacity: 1, y:0 }} transition={{durarion: 2.5}}  className='displayCard h-[300px] relative text-white bg-black rounded-md'>
                        ...
                        <motion.div initial={{opacity: 0, x: 100}} whileInView={{opacity: 1, x:0,}} transition={{durarion: 2.5}} className='displayCard h-[300px] relative text-white bg-black rounded-md'>
                        ...
                        <motion.div initial={{opacity: 0, x: 100}} whileInView={{opacity: 1, x:0,}} transition={{durarion: 2.5}} className='displayCard h-[300px] md:col-span-2 w-full relative text-white bg-black rounded-md cursor-pointer'>
